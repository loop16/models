...
st.header('CL')
bon = st.expander('Enter')
with con:
    c1, c2, c3 = bon.columns(3)

    c1.write('RDR -> ADR')
    RdrAdr_options = ['All'] + list(df['RDRtoADR'].unique())
    RDRtoADR = c1.selectbox('Select Model for RDR to ADR' , options=RdrAdr_options)
    filtered_model_df2 = df2
    if RDRtoADR == 'All':
        filtered_model_df2 = filtered_model_df2 # No filtering
    else:
        filtered_model_df2 = filtered_model_df2[filtered_model_df2['RDRtoADR'] == RDRtoADR]
    ...
    if ADRConfirm == 'All':
        ...
        filtered_model_df2 = filtered_model_df2[filtered_model_df2['ADRConfirm'] == ADRConfirm]
    ...
    if ADRbox == 'All':
        ...
        filtered_model_df2 = filtered_model_df2[filtered_model_df2['ADRBOX'] == ADRbox]
    ...
    if BrokenADR == 'All':
        ...
        filtered_model_df2 = filtered_model_df2[filtered_model_df2['BrokenADR'] == BrokenADR]


    bar_chart = alt.Chart(filtered_model_df2).mark_bar().encode(
        x=alt.X('RDRtoADR:N',sort='-y'),
        y=alt.Y('count():Q')
    )
    c1.altair_chart(bar_chart, use_container_width=True)

    word_counts = filtered_model_df2['ADRConfirm'].value_counts().reset_index()
    word_counts.columns = ['ADR Confirm', 'Count']
    ...
    word_counts2 = filtered_model_df2['ADRBOX'].value_counts().reset_index()
    word_counts2.columns = ['ADR Box Color', 'Count']
    ...
    word_countsB = filtered_model_df2['BrokenADR'].value_counts().reset_index()
    word_countsB.columns = ['ADR Broken', 'Count']
    ...
    bar_chart2 = alt.Chart(filtered_model_df2).mark_bar().encode(
        x=alt.X('MaxExtensionADR:N', bin=alt.Bin(step=0.1)),
        y=alt.Y('count():Q')
    )
    c1.altair_chart(bar_chart2, use_container_width=True)
    ...
    bar_chart3 = alt.Chart(filtered_model_df2).mark_bar().encode(
        x=alt.X('MaxRetraceADR:N',bin=alt.Bin(step=0.1)),
        y=alt.Y('count():Q')
    )
    ...
    if ADRtoODR == 'All':
        ...
        filtered_model_df2 = filtered_model_df2[filtered_model_df2['ADRtoODR'] == ADRtoODR]
    ...
    if ODRConfirm == 'All':
        ...
        filtered_model_df2 = filtered_model_df2[filtered_model_df2['ODRConfirm'] == ODRConfirm]
    ...
    if ODRbox == 'All':
        ...
        filtered_model_df2 = filtered_model_df2[filtered_model_df2['ODRBOX'] == ODRbox]
    ...
    if BrokenODR == 'All':
        ...
        filtered_model_df2 = filtered_model_df2[filtered_model_df2['BrokenODR'] == BrokenODR]
    ...
    word_counts3 = filtered_model_df2['ODRConfirm'].value_counts().reset_index()
    word_counts3.columns = ['ODR Confirm', 'Count']
    ...
    word_counts4 = filtered_model_df2['ODRBOX'].value_counts().reset_index()
    word_counts4.columns = ['ODR Box Color', 'Count']
    ...
    word_countsC = filtered_model_df2['BrokenODR'].value_counts().reset_index()
    word_countsC.columns = ['ODR Broken', 'Count']
    ...
    if ODRtoRDR == 'All':
        ...
        filtered_model_df2 = filtered_model_df2[filtered_model_df2['ODRtoRDR'] == ODRtoRDR]
    ...
    if RDRConfirm == 'All':
        ...
        filtered_model_df2 = filtered_model_df2[filtered_model_df2['RDRConfirm'] == RDRConfirm]
    ...
    if RDRbox == 'All':
        ...
        filtered_model_df2 = filtered_model_df2[filtered_model_df2['RDRBOX'] == RDRbox]
    ...
    if BrokenRDR == 'All':
        ...
        filtered_model_df2 = filtered_model_df2[filtered_model_df2['BrokenRDR'] == BrokenRDR]
    ...
    word_counts5 = filtered_model_df2['RDRConfirm'].value_counts().reset_index()
    word_counts5.columns = ['RDR Confirm', 'Count']
    ...
    word_counts6 = filtered_model_df2['RDRBOX'].value_counts().reset_index()
    word_counts6.columns = ['RDR Box Color', 'Count']
    ...
    word_countsD = filtered_model_df2['BrokenRDR'].value_counts().reset_index()
    word_countsD.columns = ['RDR Broken', 'Count']
